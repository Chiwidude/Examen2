...
/**
 * Clase que representa una Lista Posicional,  con todos los métodos implementados de la interfaz PositionalList
 * @author FRAN
 *
 * @param <E>
 */
public class PositionalLinkedList<E> implements PositionalList<E>, Iterable<E> {
	...
	/**
	 * Metodo que retorna la posición en la lista, indicado por el índice
	 * 
	 */
	public Position<E> positionAtindex(int i) {
		...
		if(index.getElement()== null) {
			throw new IndexOutOfBoundsException("No existe elemento en el índice ingresado");
		}
		else {
